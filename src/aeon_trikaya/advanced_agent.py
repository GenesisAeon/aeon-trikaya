...
class AdvancedAeonAgent:
    ...
    def __init__(
        ...
        symbol_memory_path: str | None = None,
    ...
    def save_symbol_memory(self, path: str | None = None) -> None:
...
def main(argv: list[str] | None = None) -> None:
    # See aeon_cli.main()'s identical fix: Windows locale codepages can't
    # encode this module's unicode glyph/haiku output.
